      ...
      <main className="app-shell auth-shell">
        <section className="hero-panel auth-hero-panel">
          <div className="auth-hero-grid">
            ...
            <div className="auth-hero-media" style={{ backgroundImage: `url('${HeroImages.auth}')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
